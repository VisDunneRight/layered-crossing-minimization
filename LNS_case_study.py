...
if __name__ == '__main__':
    c1, c2 = 5, 1
    ctrlflow_files = ["tail", "ptx", "sort", "sha256sum", "sleep"]
    file_selection = 3
    control_flow_file = f"control-flow-graphs/{ctrlflow_files[file_selection]}/dbg.main.dot"

    optim = LayeredOptimizer(control_flow_file, vertical_transitivity=True, bendiness_reduction=True, sequential_bendiness=False, gamma_1=c1, gamma_2=c2, cutoff_time=60)
    # barycenter(optim.g)
